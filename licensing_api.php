<?php
if( !class_exists('CMOB_Cminds_Licensing_API') )
{

    class CMOB_Cminds_Licensing_API
    {
                    ...
                    <table class="form-table">
                        <tbody>
                            <tr valign="top">
                                ...
                                <td>
                                    <input name="<?php echo $this->optionLicenseKey ?>" type="hidden" value="<?php echo $license ?>" />
                                    <input id="cminds_license_key" name="<?php echo $this->optionLicenseKey ?>" <?php echo $disabled ? 'disabled="disabled"' : ''; ?> type="text" class="regular-text" value="<?php echo $outputLicense ?>" />
                             ...
                             */
                            do_action('cminds-on-boarding-license-page');
                            ?>
                        </tbody>
                    </table>
                    <?php submit_button(); ?>
            ...
            <div class="wrap">
                ...
                <table>
                    ...
                    <tr>
                        ...
                        <td><a class="button submit-btn submit-button" href="<?php echo add_query_arg(array('check' => $this->pluginSlug)); ?>">Check for updates</a></td>
                    </tr>
                </table>
                 ...
                 * Call the action in the add-ons
                 */
                do_action('cminds-on-boarding-update-page');
                ?>
            </div>
            <?php
        }
